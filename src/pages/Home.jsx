    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-5 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {CATEGORIES.map(cat => (
            ...
            >
              <p className="text-xs tracking-widest uppercase text-[#c8a97e] mb-2">
                {cat.desc}
              </p>
              <h3 className="font-heading text-3xl text-[#1a1a1a] mb-4">
                {cat.label}
              </h3>
      ...
      <section className="max-w-7xl mx-auto px-5 pb-20">
        <div className="flex items-center justify-between mb-10">
          ...
          <Link
            to="/shop"
            className="flex items-center gap-1 text-sm text-[#c8a97e] hover:underline"
          >
      ...
      <section className="bg-[#1a1a1a] text-center py-16 px-5">
        <p className="text-xs tracking-widest uppercase text-[#c8a97e] mb-3">
          Our Promise
        </p>
